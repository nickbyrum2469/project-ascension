...
import { CaelusIntegratedCity } from "./core/CaelusIntegratedCity.js";
import { CaelusIntegratedCityPolish } from "./core/CaelusIntegratedCityPolish.js";
import { CaelusIntegratedPlaytestExtension } from "./core/CaelusIntegratedPlaytestExtension.js";
...
import { CombatRigCorrectionDirector } from "./core/CombatRigCorrectionDirector.js";
...
const boot = async (): Promise<void> => {
  ...
  try {
    ...
    const frontierContracts = new FrontierContractDirector(game);
    (game as any).frontierContracts = frontierContracts;
